...
| **v2.0-CLB** | pre-freeze | — | Under partial observability, does maintaining an explicit belief state improve closed-loop success and the model's transition knowledge, measured through counterfactual prediction error? | [`v2/`](v2/) |
