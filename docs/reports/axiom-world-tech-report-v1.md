...
**Technical Report — Protocol v1 (2026-08-23)**

Author: Minjae Kim · Author ID: `m97j` · DOI: [10.5281/zenodo.22052149](https://doi.org/10.5281/zenodo.22052149) · Code & artifacts: [https://github.com/m97j/axiom-world](https://github.com/m97j/axiom-world) (tag `v1.0.0`) · Protocol: `docs/experimental-protocol.md` v1.4 (pre-registered, amendment-logged)
...
**Answers:** RQ1 — yes, decisively and seed-robustly. RQ2 — no (≈ null). RQ3 — no; a diagnosed negative result with a mechanistic post-mortem (§6). The study's framing is deliberately **comparative**: it measures *recipe deltas under matched budgets*, not absolute task mastery (see §7).
...
Two GRPO variants on top of B4v2, sharing frozen scenario pools and decoding. Per-suite pass rates at s42 (B6-R rates derived exactly from the episode-paired flip matrices of the audited run of record `8791aa`; see **Appendix A**):
...
ultimately *world-models-as-code*, where the model writes and
...
| B6-R run / eval                        | `…--b6r-playworld-grpo-gated--s42--de963e` (rerun of record) / `20260816-201107--…--8791aa` (x20-audited) · invalid eval `f1854f` excluded (§7) · flip artifact `x19_b6r_vs_b6_flip.json`                    |
